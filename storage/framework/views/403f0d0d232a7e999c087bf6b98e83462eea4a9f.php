...
<div class="row my-3">
    <div class="col-sm-8 mx-auto bg-light  py-4 shadow-lg">
      ...
      wk-ipadp-10 line" id="i69b-2">
        <form method="post" action="<?php echo e(url ('feedback')); ?>" class="form-box">
          <?php echo csrf_field(); ?>
          <div class="row  ">
...
<?php echo $__env->make('layouts.student', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\anshi\OneDrive\Desktop\c\1619\resources\views/student/feedback.blade.php ENDPATH**/ ?>