...
<html lang="en">
  <head>
    ...
    <title>CAS Parent Dashboard</title>
    <meta charset="utf-8">
  ...
  <body class="app sidebar-mini">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="#">Parent Panel</a>
      ...
      <ul class="app-nav">
        ...
        <li class="dropdown"><a class="app-nav__item" href="#" data-bs-toggle="dropdown" aria-label="Open Profile Menu"><i class="bi bi-person fs-4"></i></a>
          <ul class="dropdown-menu settings-menu dropdown-menu-right">
            ...
            <li><a class="dropdown-item" href="<?php echo e(route('parent.logout')); ?>"><i class="bi bi-box-arrow-right me-2 fs-5"></i> Logout</a></li>
          </ul>
        </li>
      </ul>
    </header>
    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="https://randomuser.me/api/portraits/men/1.jpg" alt="User Image">
        <div>
          <p class="app-sidebar__user-name"><?php echo e(('child_name')); ?> </p>
          <p class="app-sidebar__user-designation"><?php echo e(('name')); ?></p>
        </div>
      </div>
      <ul class="app-menu">
...
</html><?php /**PATH C:\Users\anshi\OneDrive\Desktop\c\1619\resources\views/layouts/parent.blade.php ENDPATH**/ ?>