...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('name',$teacher->name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" id="father-name" name="father_name" class="form-control  <?php $__errorArgs = ['father_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid  <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('father_name',$teacher->father_name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('dob',$teacher->dob)); ?>" required>
                    <?php $__errorArgs = ['dob'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('contact',$teacher->contact)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('email',$teacher->email)); ?>" required>
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\anshi\OneDrive\Desktop\c\1619\resources\views/teacher/register.blade.php ENDPATH**/ ?>