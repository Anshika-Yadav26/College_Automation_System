...
<html lang="en">
  <head>    
    ...
    <!-- Main CSS-->
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('assets/admin/css/main.css')); ?>">
    <!-- Font-icon css-->
  ...
  <body class="app sidebar-mini">
      ...
      <ul class="app-nav">
        ...
        <li class="dropdown"><a class="app-nav__item" href="#" data-bs-toggle="dropdown" aria-label="Open Profile Menu"><i class="bi bi-person fs-4"></i></a>
          <ul class="dropdown-menu settings-menu dropdown-menu-right">
            ...
            <li><a class="dropdown-item" href="<?php echo e(route('admin.logout')); ?>"><i class="bi bi-box-arrow-right me-2 fs-5"></i> Logout</a></li>
    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="<?php echo e(('images/anshika.jpg')); ?>" alt="User Image">
        <div>
      ...
      <ul class="app-menu">
        <li><a class="app-menu__item " href="<?php echo e(route('admin.dashboard')); ?>"><i class="app-menu__icon bi bi-speedometer"></i><span class="app-menu__label">Dashboard</span></a></li>
        <li class="treeview"><a class="app-menu__item " href="#" data-toggle="treeview"><i class="app-menu__icon bi bi-laptop"></i><span class="app-menu__label">Student Information</span><i class="treeview-indicator bi bi-chevron-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="<?php echo e(route('stdview')); ?>"><i class="icon bi bi-circle-fill"></i> Student Record</a></li>
            <li><a class="treeview-item" href="<?php echo e(route('viewAttendance')); ?>" target="_blank" rel="noopener"><i class="icon bi bi-circle-fill"></i> Student Attandance</a></li>
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon bi bi-ui-checks"></i><span class="app-menu__label">Teacher Information</span><i class="treeview-indicator bi bi-chevron-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="<?php echo e(route('teacherview')); ?>"><i class="icon bi bi-circle-fill"></i> Teacher's Data</a></li>
            <li><a class="treeview-item" href="<?php echo e(route('teacherAttendance.view')); ?>"><i class="icon bi bi-circle-fill"></i> Attandance</a></li>
          </ul>
        </li>
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon bi bi-ui-checks"></i><span class="app-menu__label">View Response</span><i class="treeview-indicator bi bi-chevron-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="<?php echo e(route('viewfeedback')); ?>"><i class="icon bi bi-circle-fill"></i> Feedback</a></li>
            <li><a class="treeview-item" href="<?php echo e(route('viewcomplaint')); ?>"><i class="icon bi bi-circle-fill"></i>Complaint</a></li>
          </ul>
        </li>
        <li><a class="app-menu__item" href="<?php echo e(route('parentview')); ?>"><i class="app-menu__icon bi bi-phone"></i><span class="app-menu__label">Parent Information</span></a></li>
        <li><a class="app-menu__item" href="<?php echo e(route('viewenquiry')); ?>"><i class="app-menu__icon bi bi-phone"></i><span class="app-menu__label">View Enquiry</span></a></li>

        <li><a class="app-menu__item" href="<?php echo e(route('studyMaterial.view')); ?>"><i class="app-menu__icon bi bi-code-square"></i><span class="app-menu__label">View Study Material</span></a></li>
...
<main>
    ...
    <script src="<?php echo e(url('assets/admin/js/jquery-3.7.0.min.js')); ?>"></script>
...
</html><?php /**PATH C:\Users\anshi\OneDrive\Desktop\c\1619\resources\views/layouts/admin.blade.php ENDPATH**/ ?>