...
<html lang="en">
  <head>
    ...
    <title>CAS Teacher Dashboard</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- Main CSS-->
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('assets/teacher/css/main.css')); ?>">
    <!-- Font-icon css-->
    <link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.5/font/bootstrap-icons.css">
  </head>
  <body class="app sidebar-mini">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="#">Teacher Panel</a>
      ...
      <ul class="app-nav">
        ...
        <li class="dropdown"><a class="app-nav__item" href="#" data-bs-toggle="dropdown" aria-label="Open Profile Menu"><i class="bi bi-person fs-4"></i></a>
          <ul class="dropdown-menu settings-menu dropdown-menu-right">
            ...
            <li><a class="dropdown-item" href="<?php echo e(route('teacher.logout')); ?>"><i class="bi bi-box-arrow-right me-2 fs-5"></i> Logout</a></li>
          </ul>
        </li>
      </ul>
    </header>
      ...
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon bi bi-laptop"></i><span class="app-menu__label">Student Information</span><i class="treeview-indicator bi bi-chevron-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="<?php echo e(route('stdview')); ?>"><i class="icon bi bi-circle-fill"></i> View Student Data  </a></li>
            <li><a class="treeview-item" href="<?php echo e(route('viewAttendance')); ?>"><i class="icon bi bi-circle-fill"></i>View Student Attendance</a></li>
          </ul>
        </li>
        ...
        <li><a class="app-menu__item" href="<?php echo e(route('study.material')); ?>"><i class="app-menu__icon bi bi-code-square"></i><span class="app-menu__label">Add Study Material</span></a></li>
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon bi bi-file-earmark"></i><span class="app-menu__label">Pages</span><i class="treeview-indicator bi bi-chevron-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="#"><i class="icon bi bi-circle-fill"></i> Blank Page</a></li>
    ...
    <script src="<?php echo e(url('assets/teacher/js/jquery-3.7.0.min.js')); ?>"></script>
    <script src="<?php echo e(url('assets/teacher/js/bootstrap.min.js')); ?>"></script>
    <script src="<?php echo e(url('assets/teacher/js/main.js')); ?>"></script>
...
</html><?php /**PATH C:\Users\anshi\OneDrive\Desktop\c\1619\resources\views/layouts/teacher.blade.php ENDPATH**/ ?>