...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="#">Student Panel</a>
      ...
      <ul class="app-nav">
        ...
        <li class="dropdown"><a class="app-nav__item" href="#" data-bs-toggle="dropdown" aria-label="Open Profile Menu"><i class="bi bi-person fs-4"></i></a>
          <ul class="dropdown-menu settings-menu dropdown-menu-right">
            ...
            <li><a class="dropdown-item" href="<?php echo e(route('student.logout')); ?>"><i class="bi bi-box-arrow-right me-2 fs-5"></i> Logout</a></li>
          </ul>
        </li>
      </ul>
    </header>
      ...
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon bi bi-laptop"></i><span class="app-menu__label">Student Information</span><i class="treeview-indicator bi bi-chevron-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="#"><i class="icon bi bi-circle-fill"></i> View Student Data  </a></li>
            <li><a class="treeview-item" href="<?php echo e(('/attendance')); ?>"><i class="icon bi bi-circle-fill"></i>Student Attendance</a></li>
          </ul>
        </li>
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon bi bi-ui-checks"></i><span class="app-menu__label">Give Response</span><i class="treeview-indicator bi bi-chevron-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="<?php echo e(('/feedback')); ?>"><i class="icon bi bi-circle-fill"></i>Feedback</a></li>
            <li><a class="treeview-item" href="<?php echo e(('/complaint')); ?>"><i class="icon bi bi-circle-fill"></i>Complaint</a></li>
          </ul>
        </li>
...
</html><?php /**PATH C:\Users\anshi\OneDrive\Desktop\c\1619\resources\views/layouts/student.blade.php ENDPATH**/ ?>