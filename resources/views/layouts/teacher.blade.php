      ...
      <ul class="app-nav">
        ...
        <li class="dropdown"><a class="app-nav__item" href="#" data-bs-toggle="dropdown" aria-label="Open Profile Menu"><i class="bi bi-person fs-4"></i></a>
          <ul class="dropdown-menu settings-menu dropdown-menu-right">
            ...
            <li><a class="dropdown-item" href="{{route('teacher.logout')}}"><i class="bi bi-box-arrow-right me-2 fs-5"></i> Logout</a></li>
          </ul>
        </li>
      </ul>
    </header>
      ...
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon bi bi-laptop"></i><span class="app-menu__label">Student Information</span><i class="treeview-indicator bi bi-chevron-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="{{route('stdview')}}"><i class="icon bi bi-circle-fill"></i> View Student Data  </a></li>
            <li><a class="treeview-item" href="{{route('viewAttendance')}}"><i class="icon bi bi-circle-fill"></i>View Student Attendance</a></li>
          </ul>
        </li>
        ...
        <li><a class="app-menu__item" href="{{route('study.material')}}"><i class="app-menu__icon bi bi-code-square"></i><span class="app-menu__label">Add Study Material</span></a></li>
