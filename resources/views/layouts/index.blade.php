...
<div class="row">
  <div class="col-sm-12">
    <div class="row align-items-center">
      <div class="col-sm-2">
        <img src="{{asset('images/fgp.jpg')}}" height="150" class="ps-2 py-2">
      </div>
      <div class="col-sm-8">
      ...
      <div class="col-sm-2">
        <img src="{{asset('images/BTEUP.jpg')}}" alt="" height="150" class="py-2 ps-5">
      </div>
    </div>
  </div>
</div>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link active text-light fw-semibold px-3 ps-5 ms-4" aria-current="page" href="{{('/')}}">Home</a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link active text-light fw-semibold px-3" aria-current="page" href="{{('/enquiry')}}">&nbsp;&nbsp;Contact
                  Us</a>
              </li>
              <li class="nav-item">
                <a class="nav-link active text-light  fw-semibold px-3" aria-current="page"
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu w-100 px-2 py-2">
                  ...
                  <li><a class="dropdown-item  fw-semibold" href="{{route('student.register')}}">Student</a></li>
                  <hr>
                  <li><a class="dropdown-item  fw-semibold" href="{{route('teacher.register')}}">Teacher</a></li>
                  <hr>
                  <li><a class="dropdown-item  fw-semibold" href="{{route('parent.register')}}">Parent</a></li>
                </ul>
              </li>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu w-100 px-2 py-2">
                  <li><a class="dropdown-item fw-semibold" href="{{route('admin.login')}}">Admin Login</a></li>
                  <hr>
                  <li><a class="dropdown-item fw-semibold" href="{{route('student.login')}}">Student Login</a></li>
                  <hr>
                  <li><a class="dropdown-item  fw-semibold" href="{{route('teacher.login')}}">Teacher Login</a></li>
                  <hr>
                  <li><a class="dropdown-item  fw-semibold" href="{{route('parent.login')}}">Parent Login</a></li>
                </ul>
              </li>
            </ul>
        ...
        <div class="new_footer_top">
          <div class="container " id="smm">
            <div class="row">
              ...
              <div class="col-lg-1">
                <img src="{{asset('images/group.jpg')}}" alt="" height="210">
              </div>
